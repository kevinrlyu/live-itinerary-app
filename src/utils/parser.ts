...
- Each activity's "location" must be the SPECIFIC place name exactly as it appears in the source text. Do NOT append city names, regions, or any geographic disambiguation (e.g. use "洪崖洞民宿风貌区" not "洪崖洞民宿风貌区, Chongqing"). For child activities under a group header, use the child's own specific place (e.g. "Shizuoka City Museum of Art"), NEVER the parent's location (e.g. NOT "Shizuoka Station").
